...
<form class="max-w-md mx-auto bg-blue-50 p-2 rounded-sm">
    @if ($is_crear)
        <button type="button" wire:click.prevent="crear" class="text-black bg-blue-400 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-300 dark:hover:bg-blue-400 dark:focus:ring-blue-500">
        CREAR
        </button>
    @endif
