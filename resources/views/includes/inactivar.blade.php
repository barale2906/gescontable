<div>
    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 " role="alert">
        <span class="font-medium">¡IMPORTANTE!</span> ¿Está seguro(a) de cambiar el estado de <strong class="uppercase text-3xl"><h1>{{$nameinac}}</h1></strong><p>Su estado actual es: </p><h4 class="uppercase text-2xl">{{$statusinac===true ? "ACTIVO" : "INACTIVO"}}</h4>.
    </div>
