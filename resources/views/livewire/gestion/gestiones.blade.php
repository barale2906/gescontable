                            ...
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 dark:text-white capitalize">
                                ...
                                @else
                                    @if ($item->programacion_id)
                                        <button type="button" wire:click.prevent="show({{$item->id}},{{2}})" class="px-4 py-2 text-sm font-medium text-green-700 bg-green-300 border border-green-200 rounded-lg hover:bg-green-100 hover:text-green-700 focus:z-10 focus:ring-2 focus:ring-green-700 focus:text-green-700 dark:bg-gray-800 dark:border-green-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-500 dark:focus:text-white">
