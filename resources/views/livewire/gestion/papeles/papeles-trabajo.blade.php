<div>
    ...
    <table class=" text-sm text-left text-gray-500 dark:text-gray-400  m-4">
        <thead class=" bg-amber-200 text-xs text-gray-700  dark:bg-gray-700 dark:text-gray-400">
            <tr>
    ...
    <div class="grid sm:grid-cols-1 md:grid-cols-5 gap-3 m-3">
        ...
        @if (!$filtroparametro)
            <div class="mb-6">
                ...
                <input type="file" id="archivo" accept=".csv" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full m-2 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" wire:model.live="archivo">
                @error('archivo')
            ...
            @if ($archivo)
                <a href="" wire:click.prevent="cargar()" class="text-black bg-gradient-to-r from-amber-300 via-amber-400 to-amber-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-amber-200 dark:focus:ring-amber-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 capitalize">
                    <i class="fa-solid fa-upload"></i> Crear
                </a>
            @endif

            <a href="" wire:click.prevent="$dispatch('volviendo')" class="text-black bg-gradient-to-r from-red-300 via-red-400 to-red-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-200 dark:focus:ring-amber-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 capitalize">
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                <label for="param" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-orange-600 peer-focus:dark:text-orange-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Item a calcular</label>
            </div>
        @endif
        ...
        @if ($paradeta)
            ...
            @if ($valor && !$filtroparametro)
                <div id="alert-additional-content-1" class="p-4 mb-4 text-orange-800 border border-orange-300 rounded-lg bg-orange-50 dark:bg-gray-800 dark:text-orange-400 dark:border-orange-800" role="alert">
                    ...
                    <div class="flex">
                        <button type="button" wire:click.prevent="confirmar" class="text-white bg-orange-800 hover:bg-orange-900 focus:ring-4 focus:outline-none focus:ring-orange-200 font-medium rounded-lg text-xs px-3 py-1.5 me-2 text-center inline-flex items-center dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">
                        ...
                        @if ($is_confirma)
                            <button type="button" wire:click.prevent="finalizar" class="text-orange-800 bg-transparent border border-orange-800 hover:bg-orange-900 hover:text-white focus:ring-4 focus:outline-none focus:ring-orange-200 font-medium rounded-lg text-xs px-3 py-1.5 text-center dark:hover:bg-orange-600 dark:border-orange-600 dark:text-orange-400 dark:hover:text-white dark:focus:ring-orange-800" data-dismiss-target="#alert-additional-content-1" aria-label="Close">
